...
- [Git Detector](https://github.com/Maha1503/Git_detector) - 🔍 A Python-based tool to scan Git repositories for sensitive data leaks, like API keys, passwords, and private keys.
