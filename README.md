...
- [pyup.io](https://pyup.io/) -  Pyup scans and monitors Python projects for dependencies with known security vulnerabilities and updates them automatically. The online service is free for open source projects and comes with one private project. There's also a self-hosted open source version available.
