...
- [isMalicious](https://ismalicious.com) - Threat intelligence platform aggregating malicious IP and domain data from multiple security feeds. Provides real-time reputation scoring, threat categorization (phishing, malware, C2, botnet, ransomware), and integrations with OpenCTI, MISP, and browser extensions.
